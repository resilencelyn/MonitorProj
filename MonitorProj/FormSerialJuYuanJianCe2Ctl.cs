...
{
    public partial class FormSerialJuYuanJianCe2Ctl : Form
    {
        ...
        public FormSerialJuYuanJianCe2Ctl()
        {
            InitializeComponent();

            Global.myBoardSerialMonCtlJuYuanJianCe2Class = new BoardSerialMonCtlClass();
            Global.myBoardSerialMonCtlJuYuanJianCe2Class.EventSerialDataSend += new EventHandler(ReceiveDataFunc);
            Global.myBoardSerialMonCtlJuYuanJianCe2Class.EventSerialDataSend += new EventHandler(Global.myDataRecvToSaveClass.ReceiveDataFromSerial);

            string[] str = Global.myBoardSerialMonCtlJuYuanJianCe2Class.SerialPortCheck();
        ...
        private void btn_SerialOpen_Click(object sender, EventArgs e)
        {
            try
            {
                if (comboBox_SerialPort.Items.Count > 0)
                {
                    Global.myBoardSerialMonCtlJuYuanJianCe2Class.PortName = comboBox_SerialPort.SelectedItem.ToString();
                    Global.myBoardSerialMonCtlJuYuanJianCe2Class.BandRate = Convert.ToInt32(comboBox_Band.SelectedItem.ToString());
                    Global.myBoardSerialMonCtlJuYuanJianCe2Class.DataBits = Convert.ToInt32(comboBox_DataBitsCount.SelectedItem.ToString());
                    switch (comboBox_StopBit.SelectedIndex)
                    {
                        case 0:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.StopBits = StopBits.None;
                            break;

                        case 1:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.StopBits = StopBits.One;
                            break;

                        case 2:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.StopBits = StopBits.OnePointFive;
                            break;

                        case 3:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.StopBits = StopBits.Two;
                            break;
                    ...
                    {
                        case 0:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.Parity = Parity.Even;
                            break;

                        case 1:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.Parity = Parity.Mark;
                            break;

                        case 2:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.Parity = Parity.None;
                            break;

                        case 3:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.Parity = Parity.Odd;
                            break;

                        case 4:
                            Global.myBoardSerialMonCtlJuYuanJianCe2Class.Parity = Parity.Space;
                            break;
                    ...
                    Global.myBoardSerialMonCtlJuYuanJianCe2Class.QuiryInterval = quiryInterval;
                    Global.myBoardSerialMonCtlJuYuanJianCe2Class.SQuirys = sQuirys;

                    bool isOpened = Global.myBoardSerialMonCtlJuYuanJianCe2Class.SerialOpen();
                    Global.isSerialOpenedOK_JuYuanJianCe_2 = isOpened;
                    if (isOpened)
                    {
        ...
        private void btn_SerialClose_Click(object sender, EventArgs e)
        {
            try
            {
                bool b = Global.myBoardSerialMonCtlJuYuanJianCe2Class.SerialClose();
                string sInfo = "\t";
                if (b)
                {
                    sInfo += "串口关闭成功！\t";
        ...
        private void UpdateFormFromModelsState(object sender, GEventArgs gEventArgs)
        {
            try
            {
                ...
                {
                    if (gEventArgs.addressBoard == enum_AddressBoard.JueYuanJianCe_Board_2)
                    {
        ...
        public bool StopSerial()
        {
            try
            {
                if (Global.myBoardSerialMonCtlJuYuanJianCe2Class != null)
                {
                    Global.myBoardSerialMonCtlJuYuanJianCe2Class.Close();
                }
                return true;
            }
            catch (Exception ex)
        ...
        private void FormSerialJuYuanJianCe2Ctl_Load(object sender, EventArgs e)
        {
            try
            {
                Global.myBoardSerialMonCtlJuYuanJianCe2Class.NameIn = NameIn;
            }
            catch (Exception ex)
            { }
        }
